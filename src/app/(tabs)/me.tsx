import { BriefcaseMedical, Car, Check, GraduationCap, Plus, Settings } from 'lucide-react-native';
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.surface }]} edges={['top']}>
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.profileHeader}>
                    ...
                    <View style={[styles.verifiedTag, { backgroundColor: isDark ? 'rgba(0,229,255,0.15)' : '#E0F7FA' }]}>
                ...
                <View style={styles.sectionHeader}>
                    <Text style={[styles.sectionTitle, { color: colors.text }]}>My Identity</Text>
                    <TouchableOpacity>
                ...
                <View style={styles.sectionHeader}>
                    ...
                    <TouchableOpacity style={[styles.addButton, { backgroundColor: isDark ? colors.card : '#FFF' }]}>
